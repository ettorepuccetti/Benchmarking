...
public class WoCoServerSkeleton {
	...
	public boolean receiveData(int clientId, String dataChunk) {
		...
		if (dataChunk.indexOf(WoCoServerSkeleton.SEPARATOR)>-1) {
			//we have at least one line
			
			String bufData = sb.toString();
			
			int indexNL = bufData.indexOf(WoCoServerSkeleton.SEPARATOR);
	...
	public static void main(String[] args) throws IOException {
		...
		WoCoServerSkeleton server = new WoCoServerSkeleton();
